...
class InformationControllerTest < ActionController::TestCase
  ...
  test "should create information" do
    assert_difference('Information.count') do
      post :create, information: { email: @information.email, mob: @information.mob, name: @information.name, surname: @information.surname }
    end
  ...
  test "should update information" do
    patch :update, id: @information, information: { email: @information.email, mob: @information.mob, name: @information.name, surname: @information.surname }
    assert_redirected_to information_path(assigns(:information))
  end
